...
const SHARED_RULES = [
  ...
  "candidates 중 alreadyOnWishlist가 true인 곳은 이미 우리 위시리스트에 담아둔, 가고 싶다고 표시해둔 곳입니다. 이런 후보를 고를 때는 '새로 발견한 곳'이라고 하지 말고 '위시에 담아둔 곳을 이번에 코스에 넣기 좋다'는 취지로 reason을 쓰세요. 위시라고 해서 조건에 안 맞는데 억지로 고르지는 마세요.",
  "",
